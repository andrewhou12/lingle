 ...
 * Does NOT create the room or dispatch the agent — the browser creates
 * the room by joining it (on the correct regional node), then calls
 * /api/voice/start-agent to dispatch the agent once connected.
 */
